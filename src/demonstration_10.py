...
"""
def get_discounts(amount, discount):
    """
    a function that applies a discount d to every number in the list.
    """
    discount_num = float(discount[:-1])/100

    return [int(i * discount_num) for i in amount]
